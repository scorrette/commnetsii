...
class ExampleNet1(Mininet):
    def __init__(self):
        ...
        r2 = self.addHost('r2', ip='10.0.1.2/24')
        r3 = self.addHost('r3', ip='10.0.2.2/24')
        r4 = self.addHost('r4', ip='10.0.4.1/24')
        r5 = self.addHost('r5', ip='10.0.4.2/24')
        r6 = self.addHost('r6', ip='10.0.3.2/24')
        r7 = self.addHost('r7', ip='10.0.7.1/24')
        r8 = self.addHost('r8', ip='10.0.7.2/24')
        r9 = self.addHost('r9', ip='10.0.6.2/24')

        info("*** Creating hosts\n")
        h1 = self.addHost('h1', ip='192.168.1.1/24', defaultRoute='via 192.168.1.2/24')
        h2 = self.addHost('h2', ip='192.168.2.1/24', defaultRoute='via 192.168.2.2/24')
        h3 = self.addHost('h3', ip='192.168.3.1/24', defaultRoute='via 192.168.3.2/24')
...
class ExampleNet2(Mininet):
    def __init__(self):
        ...
        r1 = self.addHost('r1', ip='10.0.1.1/24')
        r2 = self.addHost('r2', ip='10.0.1.2/24')
        r3 = self.addHost('r3', ip='10.0.1.3/24')
        r4 = self.addHost('r4', ip='10.0.1.4/24')
        r5 = self.addHost('r5', ip='10.0.2.2/24')
        r6 = self.addHost('r6', ip='10.0.3.2/24')
        r7 = self.addHost('r7', ip='10.0.4.2/24')

        info("*** Creating hosts\n")
        h1 = self.addHost('h1', ip='192.168.1.1/24', defaultRoute='via 192.168.1.2/24')
        h2 = self.addHost('h2', ip='192.168.2.1/24', defaultRoute='via 192.168.2.2/24')
        h3 = self.addHost('h3', ip='192.168.3.1/24', defaultRoute='via 192.168.3.2/24')
        h4 = self.addHost('h4', ip='192.168.4.1/24', defaultRoute='via 192.168.4.2/24')
...
class ExampleNet3(Mininet):
    def __init__(self):
        ...
        info("*** Creating routers\n")
        r1 = self.addHost('r1', ip='10.0.1.1/24')
        r2 = self.addHost('r2', ip='10.0.1.3/24')
        r3 = self.addHost('r3', ip='10.0.1.4/24')
        r4 = self.addHost('r4', ip='10.0.4.1/24')
        r5 = self.addHost('r5', ip='10.0.3.2/24')
        r6 = self.addHost('r6', ip='10.0.5.2/24')
...
class DemoNet(Mininet):
    def __init__(self):
        Mininet.__init__(self, controller=None, cleanup=True)

        # Creating Hosts
        info("*** Creating routers\n")
        r1 = self.addHost('r1', ip='10.0.2.2/24')
        r2 = self.addHost('r2', ip='10.0.2.1/24')
        r3 = self.addHost('r3', ip='10.0.3.1/24')
        r4 = self.addHost('r4', ip='10.0.4.1/24')
        r5 = self.addHost('r5', ip='10.0.5.1/24')
        r6 = self.addHost('r6', ip='10.0.6.1/24')
        r7 = self.addHost('r7', ip='10.0.7.1/24')
        ...
        self.addLink(r2, r6, intfName1='r2-eth2', intfName2='r6-eth0')
        self.addLink(r6, r7, intfName1='r6-eth1', intfName2='r7-eth0')
        self.addLink(r3, r4, intfName1='r3-eth2', intfName2='r4-eth0')
        self.addLink(r3, r5, intfName1='r3-eth3', intfName2='r5-eth0')

        self.addLink(r1, h1, intfName1='r1-eth2', intfName2='h1-eth0')
        self.addLink(r7, h2, intfName1='r7-eth1', intfName2='h2-eth0')
        self.addLink(r4, h3, intfName1='r4-eth1', intfName2='h3-eth0')
        self.addLink(r5, h4, intfName1='r5-eth1', intfName2='h4-eth0')
        ...
        r4.setIP('192.168.3.2/24', intf='r4-eth1')
        r5.setIP('192.168.4.2/24', intf='r5-eth1')
